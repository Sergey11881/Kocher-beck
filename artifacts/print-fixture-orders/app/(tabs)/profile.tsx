...
const styles = StyleSheet.create({
  ...
  managers: { gap: 10 },
  managerCard: { borderRadius: 17, padding: 0, marginHorizontal: 4 },
  managerIcon: { width: 38, height: 38, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  managerCopy: { flex: 1, alignItems: 'center' },
  managerName: { fontSize: 19, lineHeight: 24, textAlign: 'center', fontFamily: 'Inter_700Bold', marginBottom: 3 },
  managerRole: { fontSize: 16, lineHeight: 21, textAlign: 'center', fontFamily: 'Inter_400Regular', marginBottom: 5 },
  managerPhone: { fontSize: 17, lineHeight: 22, textAlign: 'center', fontFamily: 'Inter_600SemiBold' },
});